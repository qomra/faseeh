...
def parse_args():
    ...
    parser.add_argument('--dataset_path', type=str, default='root_analysis_dataset_short.json',
...
def train_model(args):
    ...
    training_args = TrainingArguments(
        ...
        eval_steps=5,  # Less frequent evaluation
        logging_strategy="steps",
        logging_steps=20,
        save_strategy="steps",
        save_steps=5,  # Less frequent saving
...
def run_inference(args):
    ...
    while True:
        ...
        with torch.no_grad():
            ...
            #         break
            # Simple non-streaming alternative
